...
sourceCode['ButtonGroup.module.scss'] = ''
  ...
  + '      border-inline-end-color: var(--button-border-separator-color, var(--button-border-color));\n'
  + '    }\n'
  + '\n'
  ...
  + '      border-inline-end-width: calc(var(--button-border-width) / 2);\n'
  + '      border-inline-start-color: var(--button-border-separator-color, var(--button-border-color));\n'
  + '      border-inline-end-color: var(--button-border-separator-color, var(--button-border-color));\n'
  + '    }\n'
  + '\n'
