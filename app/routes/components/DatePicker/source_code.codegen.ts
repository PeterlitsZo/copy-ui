...
sourceCode['calendar-opener.module.css'] = ''
  + '@layer components {\n'
  + '  .calendarOpener {\n'
  + '    display: flex;\n'
  + '    align-items: center;\n'
  ...
  + '    width: 90%;\n'
  + '    height: 90%;\n'
  + '    color: var(--calendarOpenerTrigger-color);\n'
  + '    border-radius: 999999px;\n'
  + '    cursor: pointer;\n'
  + '\n'
  + '    &:hover {\n'
  + '      background-color: var(--calendarOpenerTrigger-hover-bgColor);\n'
  + '    }\n'
  + '  }\n'
  + '}\n'
  ;

sourceCode['date-picker.module.css'] = ''
  + '@layer components {\n'
  + '  .datePickerInput {\n'
  + '    padding-inline: var(--dataPickerInput-paddingInline);\n'
  + '    user-select: none;\n'
  + '  }\n'
  + '\n'
  + '  .datePickerInputPart {\n'
  ...
  + '\n'
  + '    &:hover {\n'
  + '      background-color: var(--dataPickerInputPart-hover-bgColor);\n'
  + '    }\n'
  + '\n'
  + '    &:focus {\n'
  + '      background-color: var(--dataPickerInputPart-focus-bgColor);\n'
  + '    }\n'
  + '\n'
  + '    &:focus-visible {\n'
  + '      outline: none;\n'
  ...
  + '\n'
  + '    &.noValue {\n'
  + '      color: var(--dataPickerInputPart-noValue-color);\n'
  + '    }\n'
  + '  }\n'
  + '\n'
  + '  .datePickerInputDecorator {\n'
  + '    position: relative;\n'
  + '    color: var(--dataPickerInputDecorator-color);\n'
  + '    padding: 0 0.5px;\n'
  + '  }\n'
  + '}\n'
  ;
