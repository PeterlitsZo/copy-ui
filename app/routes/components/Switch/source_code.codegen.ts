...
sourceCode['switch.module.scss'] = ''
  ...
  + '\n'
  + '    background-color: var(--switchRail-bg);\n'
  + '\n'
  + '    cursor: pointer;\n'
  + '\n'
  ...
  + '\n'
  + '    &[data-checked="true"] {\n'
  + '      background-color: var(--switchRail-checked-bg);\n'
  ...
  + '\n'
  + '    background-color: var(--switchThumb-bg);\n'
  + '\n'
  + '    transition: left 0.15s, border-color 0.15s;\n'
  + '\n'
  + '    .rail[data-checked="true"] & {\n'
  + '      left: calc(var(--switchRail-h) * 1.75 - var(--switchRail-h) + var(--switchThumb-gap));\n'
