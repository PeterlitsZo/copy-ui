...
sourceCode['typography-codeblock.tsx'] = ''
...
sourceCode['typography-list.module.css'] = ''
  + '@layer components {\n'
  + '  .ul {\n'
  + '    margin-bottom: 1rem;\n'
  + '\n'
...
sourceCode['typography-common.tsx'] = ''
  + 'import classNames from "classnames";\n'
  + 'import type { ComponentProps, FC } from "react";\n'
  + '\n'
  ...
  + '\n'
  + '  return (\n'
  + '    <a className={classNames(styles.a, stx, className)} {...rest}>\n'
  + '      {children}\n'
  + '    </a>\n'
  + '  );\n'
  + '};\n'
...
sourceCode['typography-code.module.css'] = ''
  + '@layer components {\n'
  + '  .code {\n'
...
sourceCode['typography-headings.module.css'] = ''
  + '@layer components {\n'
  + '  .h1 {\n'
  + '    margin-top: 2rem;\n'
  + '    margin-bottom: 1rem;\n'
...
sourceCode['typography-codeblock.module.css'] = ''
  + '@layer components {\n'
  + '  .codeBlock {\n'
  + '    margin-bottom: 1rem;\n'
  + '  }\n'
...
sourceCode['typography-list.tsx'] = ''
  + 'import classNames from "classnames";\n'
  + 'import type { ComponentProps, FC } from "react";\n'
  + '\n'
...
sourceCode['typography-common.module.css'] = ''
  + '@layer components {\n'
  + '  .strong {\n'
  + '    font-weight: 600;\n'
  + '  }\n'
...
sourceCode['index.ts'] = ''
  + '// Typography from copy-ui (version: 0.1.12, date: 2026-02-18).\n'
  + '\n'
  + 'export { Typography } from "./typography";\n'
  ;

sourceCode['typography.module.css'] = ''
  + '@layer components {\n'
...
sourceCode['typography-code.tsx'] = ''
  + 'import classNames from "classnames";\n'
  + 'import type { ComponentProps, FC } from "react";\n'
  + '\n'
  + 'import { useTheme } from "@/components/CopyUiProvider";\n'
