...
export const components: { name: string, path: string, wip: boolean }[] = [
  ...
  {"name": "Breadcrumb", "path": "/v0/components/Breadcrumb", "wip": false},
  ...
  {"name": "Markdown", "path": "/v0/components/Markdown", "wip": false},
  {"name": "Modal", "path": "/v0/components/Modal", "wip": false},
  {"name": "Paper", "path": "/v0/components/Paper", "wip": false},
  ...
  {"name": "Spinner", "path": "/v0/components/Spinner", "wip": false},
