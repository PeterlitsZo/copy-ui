...
def codegen():
    ...
    for component_name in os.listdir(components_dir):
        ...
        codegen_demo_for_component(component_route_dir_path, output_demo_file_path)
    ...
    with open(navbar_components_codegen_path, 'w', encoding='utf-8') as of:
        ...
        of.write("export const components: { name: string, path: string, wip: boolean }[] = [\n")
...
def codegen_demo_for_component(component_route_dir_path: str, of_path: str):
    """
